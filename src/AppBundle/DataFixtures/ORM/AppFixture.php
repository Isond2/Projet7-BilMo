...
class AppFixture extends Fixture
{
    ...
    //Fabricants
        ...
        //Samsung 
        $Samsung = new Fabricant();
        $Samsung->setFabricantName('Samsung');
        $manager->persist($Samsung);

        //Apple 
        $Apple = new Fabricant();
        $Apple->setFabricantName('Apple');
        $manager->persist($Apple);

        //LG 
        $LG = new Fabricant();
        $LG->setFabricantName('LG');
        $manager->persist($LG);
    ...
    //Telephones
        ...
        //Samsung
            ...
            $phone1->setPhoneFabricant($Samsung);
            ...
            $phone2->setPhoneFabricant($Samsung);
            ...
            $phone3->setPhoneFabricant($Samsung);
        ...
        //Apple
            ...
            $phone4->setPhoneFabricant($Apple);
            ...
            $phone5->setPhoneFabricant($Apple);
            ...
            $phone6->setPhoneFabricant($Apple);
